...
def evaluate_report():
    ...
    RETRIEVED_CONTEXT = """
    - 기사 발행일(2022-10-07): 미국 정부가 중국 반도체 산업을 겨냥해 광범위한 수출 통제 조치를 단행했다. 상무부는 18nm 이하 D램, 128단 이상 낸드플래시, 14nm 이하 로직칩 등을 생산할 수 있는 장비 및 기술의 중국 수출을 통제한다고 발표했다.
    - 기사 발행일(2022-10-12): 미국의 강력한 수출 제재 여파로 어플라이드 머티어리얼즈(AMAT), KLA, 램리서치 등 글로벌 반도체 장비 업체들이 중국 양쯔메모리테크놀로지(YMTC) 등 중국 내 주요 고객사 공장에서 자사 인력들을 긴급 철수시키고 있다.
    - 기사 발행일(2022-10-25): 미국 상무부의 제재로 인해 중국 반도체 팹들의 신규 라인 증설이 전면 중단될 위기에 처했으며, 이로 인해 단기적으로 중국의 반도체 장비 및 부품 수입량이 기록적으로 급감하고 있다.
    """
